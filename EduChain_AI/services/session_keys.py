...
MGMT_DETAIL_TAB = "mgmt_detail_tab"  # basic | plan | people | content
...
# 교사: 본문 탭 — overview | students | course_stats | lesson_mgmt (선택 수업 맥락)
...
# 학생: 개요 | 수업 화면
STUDENT_VIEW_TAB = "student_view_tab"  # "overview" | "course"
